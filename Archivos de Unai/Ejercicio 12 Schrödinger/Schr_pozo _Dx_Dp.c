...
{ /* Metodo de diferencias finitas.
    ...
    es una ecuacion de autovalores y autovectores.
    
    Se resuelve numericamente usando el paquete libre eispack (de GNU) que
  ...
  */
	...
	*/
	...
	for (int i = conf.nivel_elegido; i < 5; i++)
	{
		conf.nivel_elegido = i;
